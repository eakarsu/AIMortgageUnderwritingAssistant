...
// Feature: Third Party
// Description: Third-party ordering hub (appraisals, inspections, title)
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: Third Party. Third-party ordering hub (appraisals, inspections, title)' },
