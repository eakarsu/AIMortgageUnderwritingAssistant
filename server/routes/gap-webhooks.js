...
// Feature: Webhooks
// Description: Webhooks for LOS integrations (Encompass, Calyx)
  ...
  try {
    const r = await fetch('https://openrouter.ai/api/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          { role: 'system', content: 'You are an expert assistant for: Webhooks. Webhooks for LOS integrations (Encompass, Calyx)' },
