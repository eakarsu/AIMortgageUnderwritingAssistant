...
// Agentic
// Agentic underwriting assistant orchestrating doc collection + conditions + risk assessment
...
export default function GapAgentic() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Agentic underwriting assistant orchestrating doc collection + conditions + risk assessment</p>
