...
// Pricing
// Pricing engine (rate sheets, discount points)

export default function GapPricing() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-pricing', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Pricing</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Pricing engine (rate sheets, discount points)</p>
