...
// Borrower
// Borrower engagement agent driving proactive comms on missing docs

export default function GapBorrower() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-borrower', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Borrower</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Borrower engagement agent driving proactive comms on missing docs</p>
