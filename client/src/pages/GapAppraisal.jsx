...
// Appraisal
// Appraisal order management (vendor ordering)

export default function GapAppraisal() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-appraisal', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Appraisal</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Appraisal order management (vendor ordering)</p>
