...
// Vision Based
// Vision-based document intelligence (paystubs, tax returns, bank statements)
...
export default function GapVisionBased() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Vision-based document intelligence (paystubs, tax returns, bank statements)</p>
